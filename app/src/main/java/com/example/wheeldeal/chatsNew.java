...
public class chatsNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //chatOpen
        ImageView imgChatOpen = findViewById(R.id.clickChatInterface);

        imgChatOpen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chatOpenIntent = new Intent(getApplicationContext(), openchat.class);
